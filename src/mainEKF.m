...
close all;
clearvars -except currDataIndex srcFolderPath topLevelPath collectedDataPath runDataFolders numSteps useGTOnly useLandmarksOnly useTrustFactor trustFactorTime results* filterName
...
for currDataIndex=1:length(runDataFolders)
    ...
    useObservationsToCorrect = ~useLandmarksOnly;
    %useLandmarksOnly = false;
    useGTForObservedRobots = useGTOnly;
